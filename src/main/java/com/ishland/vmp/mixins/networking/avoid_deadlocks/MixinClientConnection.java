...
public class MixinClientConnection {
    ...
    @Redirect(method = "method_60924", at = @At(value = "INVOKE", target = "Lio/netty/channel/ChannelFuture;awaitUninterruptibly()Lio/netty/channel/ChannelFuture;", remap = false))
